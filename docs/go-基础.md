...
![Go家族树](https://cnymw.github.io/go-study/docs/img/go-tree.png)
...
go 基础的思维导图的原件以及 PDF 在 [go 基础思维导图](https://github.com/cnymw/go-study/tree/master/docs/mind/go基础) 下面，有需要的可以下载以便随时查看。

![go 基础](https://cnymw.github.io/go-study/docs/img/go基础.jpg)