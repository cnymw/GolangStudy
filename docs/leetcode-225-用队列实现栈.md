...
![stack](https://golangstudy-1301931916.cos.ap-shanghai.myqcloud.com/img/数据结构-栈-临时栈1.png)

出栈的顺序为={5,4,3,2,1}

将原始序列插入到队列 A 中，得到的队列如下所示：

![queueA](https://golangstudy-1301931916.cos.ap-shanghai.myqcloud.com/img/数据结构-栈-临时队列1.png)
...
![queueB](https://golangstudy-1301931916.cos.ap-shanghai.myqcloud.com/img/数据结构-栈-临时栈2.png)
