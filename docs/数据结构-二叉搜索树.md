...
![树示例1](https://cnymw.github.io/GolangStudy/docs/img/数据结构-二叉搜索树/数据结构-二叉搜索树-树示例1.png)
...
![查找伪代码](https://cnymw.github.io/GolangStudy/docs/img/数据结构-二叉搜索树/数据结构-二叉搜索树-查找伪代码.png)
...
![查找最小元素伪代码](https://cnymw.github.io/GolangStudy/docs/img/数据结构-二叉搜索树/数据结构-二叉搜索树-查找最小元素伪代码.png)
...
![查找最大元素伪代码](https://cnymw.github.io/GolangStudy/docs/img/数据结构-二叉搜索树/数据结构-二叉搜索树-查找最大元素伪代码.png)
...
![查找后继伪代码](https://cnymw.github.io/GolangStudy/docs/img/数据结构-二叉搜索树/数据结构-二叉搜索树-查找后继伪代码.png)
...
![插入伪代码](https://cnymw.github.io/GolangStudy/docs/img/数据结构-二叉搜索树/数据结构-二叉搜索树-插入伪代码.png)
