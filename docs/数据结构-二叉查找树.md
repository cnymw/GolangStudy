...
![示例](https://cnymw.github.io/go-study/docs/img/example.png)
...
二叉查找树的思维导图的原件以及 PDF 在 [二叉查找树思维导图](https://github.com/cnymw/go-study/tree/master/docs/mind/二叉查找树) 下面，有需要的可以下载以便随时查看。

![二叉查找树](https://cnymw.github.io/go-study/docs/img/二叉查找树.jpg)