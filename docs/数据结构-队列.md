...
![空队列](https://gitee.com/GolangStudy_1/AliGolangStudy/raw/master/docs/img/数据结构-队列/数据结构-队列-临时队列1.png)

满队列时如下所示,front=(rear+1)%5=(5+1)%5=1：

![满队列](https://gitee.com/GolangStudy_1/AliGolangStudy/raw/master/docs/img/数据结构-队列/数据结构-队列-临时队列2.png)

或者,front=(rear+1)%5=(2+1)%5=3:

![满队列2](https://gitee.com/GolangStudy_1/AliGolangStudy/raw/master/docs/img/数据结构-队列/数据结构-队列-临时队列3.png)
...
![数据结构-队列-思维导图.jpg](https://gitee.com/GolangStudy_1/AliGolangStudy/raw/master/docs/img/数据结构-队列/数据结构-队列-思维导图.jpg)

## pdf

[数据结构-队列-思维导图.pdf](https://gitee.com/GolangStudy_1/AliGolangStudy/raw/master/docs/img/数据结构-队列/数据结构-队列-思维导图.pdf)

## 在线查看

[数据结构-队列-思维导图.html](https://gitee.com/GolangStudy_1/AliGolangStudy/raw/master/docs/img/数据结构-队列/数据结构-队列-思维导图.html)
