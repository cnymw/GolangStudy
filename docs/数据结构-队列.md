...
![空队列](https://cnymw.github.io/go-study/docs/img/空队列.png)

满队列时如下所示,front=(rear+1)%5=(5+1)%5=1：

![满队列.png](https://cnymw.github.io/go-study/docs/img/满队列.png)

或者,front=(rear+1)%5=(2+1)%5=3:

![满队列2.png](https://cnymw.github.io/go-study/docs/img/满队列2.png)
...
队列的思维导图的原件以及 PDF 在 [队列思维导图](https://github.com/cnymw/go-study/tree/master/docs/mind/队列) 下面，有需要的可以下载以便随时查看。

![队列](https://cnymw.github.io/go-study/docs/img/队列.jpg)