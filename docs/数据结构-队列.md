...
队列的思维导图的原件以及 PDF 在 [队列思维导图](https://github.com/cnymw/GolangStudy/tree/master/docs/mind/数据结构-队列) 下面，有需要的可以下载以便随时查看。

![队列](https://cnymw.github.io/GolangStudy/docs/img/数据结构-队列/数据结构-队列-思维导图.jpg)