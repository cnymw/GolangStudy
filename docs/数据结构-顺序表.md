...
顺序表的思维导图的原件以及 PDF 在 [顺序表思维导图](https://github.com/cnymw/go-study/tree/master/docs/mind/顺序表) 下面，有需要的可以下载以便随时查看。

![顺序表](https://cnymw.github.io/go-study/docs/img/顺序表.jpg)