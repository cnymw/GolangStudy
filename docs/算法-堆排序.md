...
![结构图](https://golangstudy-1301931916.cos.ap-shanghai.myqcloud.com/img/算法-堆排序-结构图.png)
...
![maxheapify](https://golangstudy-1301931916.cos.ap-shanghai.myqcloud.com/img/算法-堆排序-maxheapify.png)

### 建堆

我们可以用自底向上的方法利用过程 MAX-HEAPIFY 把数组转换为最大堆。

![build-max-heap](https://golangstudy-1301931916.cos.ap-shanghai.myqcloud.com/img/算法-堆排序-buildmaxheap.png)
...
![示例1](https://golangstudy-1301931916.cos.ap-shanghai.myqcloud.com/img/算法-堆排序-示例1.png)
...
![heapsort](https://golangstudy-1301931916.cos.ap-shanghai.myqcloud.com/img/算法-堆排序-heapsort.png)
