...
![序列](https://golangstudy-1301931916.cos.ap-shanghai.myqcloud.com/img/算法-归并排序-序列1.png)

伪代码如下所示：

![MERGE-SORT](https://golangstudy-1301931916.cos.ap-shanghai.myqcloud.com/img/算法-归并排序-MERGE-SORT.png)
...
![递归式1](https://golangstudy-1301931916.cos.ap-shanghai.myqcloud.com/img/算法-归并排序-递归式1.png)

由此递归式可以进一步分析得出递归树：

![递归树1](https://golangstudy-1301931916.cos.ap-shanghai.myqcloud.com/img/算法-归并排序-递归树1.png)
