...
![UML](https://cnymw.github.io/go-study/docs/img/策略模式.png)
...
策略模式的思维导图的原件以及 PDF 在 [策略模式思维导图](https://github.com/cnymw/go-study/tree/master/docs/mind/策略模式) 下面，有需要的可以下载以便随时查看。

![策略模式](https://cnymw.github.io/go-study/docs/img/策略模式.jpg)