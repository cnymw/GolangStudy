...
装饰器模式的思维导图的原件以及 PDF 在 [装饰器模式思维导图](https://github.com/cnymw/GolangStudy/tree/master/docs/mind/设计模式-装饰器模式) 下面，有需要的可以下载以便随时查看。

![装饰器模式](https://cnymw.github.io/GolangStudy/docs/img/设计模式-装饰器模式/设计模式-装饰器模式-思维导图.jpg)