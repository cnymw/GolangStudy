...
![UML](https://golangstudy-1301931916.cos.ap-shanghai.myqcloud.com/img/设计模式-装饰器模式-uml.png)
...
![设计模式-装饰器模式-思维导图.jpg](https://golangstudy-1301931916.cos.ap-shanghai.myqcloud.com/img/设计模式-装饰器模式-思维导图.jpg)

## pdf

[设计模式-装饰器模式-思维导图.pdf](https://golangstudy-1301931916.cos.ap-shanghai.myqcloud.com/img/设计模式-装饰器模式-思维导图.pdf)

## 在线查看

[设计模式-装饰器模式-思维导图.html](https://golangstudy-1301931916.cos.ap-shanghai.myqcloud.com/img/设计模式-装饰器模式-思维导图.html)
